...
class ZFDebug_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
    ...
    public function dispatchLoopShutdown()
    {
        ...
        foreach ($this->plugins as $plugin) {
            ...
            && file_exists($this->options['image_path'] .'/'. $plugin->getIdentifier() .'.png')) {
                $pluginIcon = $this->options['image_path'] .'/'. $plugin->getIdentifier() .'.png';
            } else {
    ...
    protected function icon($kind)
    {
        switch ($kind) {
            ...
            default:
                ...
                return $this->options['image_path'] . '/unknown.png';
                break;
        }
    }
